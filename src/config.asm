...
config_apply:; Function begin
	...
	jne     loc_053
loc_044:  mov     edx, dword [rbx+0x1A8]
	test    edx, edx
	jnz     loc_052
loc_045:  mov     edi, dword [rbx+0x1AC]
	test    edi, edi
	jnz     loc_051
loc_046:  cmp     byte [rbx+0x1B4], 0
	jnz     loc_050
loc_047:  mov     eax, dword [rbx+0x3B8]
	test    eax, eax
	jnz     loc_049
loc_048:  pop     rbx
	ret
...
ALIGN   8
loc_049:  mov     edi, dword [rbx+0x3B4]
	pop     rbx
	jmp     set_use_binary
...
ALIGN   16
loc_051:  call    set_gentoo_chroot
...
ALIGN   8
loc_052:  mov     edi, dword [rbx+0x1A4]
	call    set_use_pipe
